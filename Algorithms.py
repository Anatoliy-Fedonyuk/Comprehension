...
# a = [7, 5, -8, 0, 10, 1]
# N = len(a) - 1  # число элементов в списке
#
# for i in range(0, N):  # N итераций работы алгоритма
#     for j in range(0, N - i):  # проход по оставшимся не отсортированным парам массива
#         if a[j] < a[j + 1]:
#             a[j], a[j + 1] = a[j + 1], a[j]
#
# print(a)
...
""" Быстрая сортировка слиянием (merge sort) / максимальная O(n)"""
